...
The electron source bug was found by a forward comparison, but no automated frozen-field reciprocity test
exists. A minimal nonzero-field geometry should compare forward tally and backward gather for both species
with confidence/error bars and trajectory-step refinement.
