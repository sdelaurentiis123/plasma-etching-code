...
def run(label, reinit, warm, nfp, gsmooth, gsrc, gmesh, samp):
...
run("warmup", "fsm", True, 1, True, True, True, "sobol")

base = run("ORIGINAL: cold n_fp=4, skfmm-CPU, CPU-smooth, sobol-host, CPU-mesh",
           "skfmm", False, 4, False, False, False, "sobol")
best = run("FULL GPU: warm n_fp=1, fsm, GPU-smooth, GPU-source, GPU-mesh",
           "fsm", True, 1, True, True, True, "sobol")
