...
| Product redeposition | Species-resolved production, flight, reaction/sticking, and exact material balance | Missing | Scalar velocity-derived products, fixed sticking, and a charging/etch-stop foot-band suppression hack | Time-resolved necking/taper and trench-to-hole transfer | Replace rather than port; the foot-band branch must be retired |
