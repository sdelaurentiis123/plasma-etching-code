...
| [`christophorou-olthoff-rao-1996-cfx`](library/christophorou-olthoff-rao-1996-cfx.md) | NIST-evaluated measured secondary CF/CF2/CF3 ionization curves | PRIMARY NIST FULL TEXT + TABLES 31--33 PIXEL-AUDITED AT 240 DPI |
...
| [`harmon-2019-ngp80-rie`](library/harmon-2019-ngp80-rie.md) | Harmon, exact PlasmaPro NGP80 CHF3 recipe and conditioning-driven self-bias drift | PRIMARY FULL THESIS + BIAS PAGE VISUALLY AUDITED |
| [`penaud-2006-plasmalab80-ternary`](library/penaud-2006-plasmalab80-ternary.md) | Penaud, PlasmaLab 80 SF6/O2/CHF3 bias and anisotropy table | PRIMARY FULL THESIS + TABLES/SEMS VISUALLY AUDITED |
| [`zou-2004-plasmalab80-sf6-o2`](library/zou-2004-plasmalab80-sf6-o2.md) | Zou, PlasmaLab 80+ SF6/O2 bias-pressure-loading study | PRIMARY FULL ARTICLE + FIGURES VISUALLY AUDITED |
...
| [`pateau-2014-sf6-o2`](library/pateau-2014-sf6-o2.md) | Pateau et al., O2 daughter and SFx/O titration chemistry | PRIMARY FULL TEXT + TABLES I, III, V, VII VISUALLY AUDITED AND CONSERVATION-CHECKED |
...
| [`hagelaar-pitchford-2005-bolsig`](library/hagelaar-pitchford-2005-bolsig.md) | Hagelaar & Pitchford, deterministic two-term electron Boltzmann solver | PRIMARY FULL ARTICLE + EQUATIONS 3, 9, 36--38, 44--45 VISUALLY AUDITED |
| [`gregorio-pitchford-2012-cl2`](library/gregorio-pitchford-2012-cl2.md) | Gregorio & Pitchford, legacy Cl2 cross-section compilation and swarm inversion | PRIMARY FULL TEXT READ ONLINE; NUMBERS NOT IMPORTED |
| [`griffin-1995-cl`](library/griffin-1995-cl.md) | Griffin et al., calculated atomic-Cl elastic/excitation/ionization cross sections | PRIMARY APS RECORD + ABSTRACT; FULL PDF REQUIRED |
...
| [`kemaneci-2014-chlorine-global`](library/kemaneci-2014-chlorine-global.md) | Kemaneci et al., detailed continuous/pulsed chlorine global model and energy-ledger topology | PRIMARY FULL TEXT + EQUATIONS 13--18 AT 500 DPI; TABLE 4/FIGURE 10 AT 600 DPI |
...
| [`choi-2013-tio2-cf4`](library/choi-2013-tio2-cf4.md) | Choi et al., TiO2 O2/CF4/Ar multiaxis surface response | PRIMARY FULL TEXT ONLINE + SOURCE-REPORTED FIGURES 2--6 ENDPOINTS AUDITED |
| [`ji-2024-tio2-hierarchical`](library/ji-2024-tio2-hierarchical.md) | Ji et al., same-gas TiO2/Cr two-zone profile evolution | PRIMARY CC-BY FULL TEXT + FIGURES 3/4 QUANTITATIVELY PIL-AUDITED |
...
| [`depla-2024-oxide-sputter`](library/depla-2024-oxide-sputter.md) | Depla and Van Bever, semi-empirical oxide sputter yields | PRIMARY AUTHOR-REPOSITORY FULL TEXT + TiO2 FIT DIGITIZED |
...
| TiO2 multiaxis response: bias `130.9` to `197.2 nm/min`, nonmonotonic O2 response, power/pressure response, and AFM chemistry dependence | [`choi-2013-tio2-cf4`](library/choi-2013-tio2-cf4.md) | requires energy-dependent ion assistance, F/O competition, collisional delivery, and a morphology score; different CF4/Ar ICP and film prohibit Oxford coefficient transfer |
...
| Bare TiO2 Ar-sputter reference (`0.192` formula units/ion at `276 eV`) | [`depla-2024-oxide-sputter`](library/depla-2024-oxide-sputter.md) | checksum-pinned digitization of the source's semi-empirical fit; establishes a physical-sputter scale but is neither a direct low-energy measurement nor the Oxford reactive mixed-ion coefficient |
...
| Bounded chlorine wall coverage sensitivity | [`stafford-2010-cl-wall`](library/stafford-2010-cl-wall.md), [`malyshev-1998-lam-cl2`](library/malyshev-1998-lam-cl2.md) | differentiable Langmuir--Hill response is fitted only to direct spinning-wall markers and bounded by their largest observed gamma; ratio/temperature extension is explicit sensitivity evidence and never selected from reactor or depth data |
