...
| [`choi-2013-tio2-cf4`](library/choi-2013-tio2-cf4.md) | Choi et al., TiO2 O2/CF4/Ar bias and surface response | PRIMARY FULL TEXT ONLINE + SOURCE-REPORTED FIGURE-5 ENDPOINTS AUDITED |
...
| TiO2 bias-response sign (`130.9` to `197.2 nm/min` from `-50` to `-250 V`) and Ti-F/product-desorption topology | [`choi-2013-tio2-cf4`](library/choi-2013-tio2-cf4.md) | rejects energy-independent removal as a complete TiO2 law; different CF4/Ar ICP and film prohibit Oxford coefficient transfer |
