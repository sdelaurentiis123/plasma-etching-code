...
|---|---|---|
| Q1 | \| `RESEARCH_THESIS_MINING_2026-07-23.md` §S2 \| "Guo, Wei — PhD MIT 2008 — MIT DSpace 1721.1/43201" \| 43201 = **Kawai, Hiroyo (2008)**. Guo, Wei (2009) = **1721.1/46600** \| | `RESEARCH_BEAM_CONSTANTS_ATLAS_2026-07-29.md`:691 |
| U2 | [unquoted — verify on next use] \| **L1** \| Regressed from **blanket beam yields** with independently measured ion/neutral fluxes (Chang 1998; Kwon TML; Guo 2009) \| Free for **profile** gates — the fit never saw a feature \| | `RESEARCH_BEAM_CONSTANTS_ATLAS_2026-07-29.md`:29 |
...
| Q8 | Original-resolution inspection of Equations 16--17 and Figure 2.2 pins the finite-history topology. Equation 17 evolves atom fractions from reaction yields, so the dimensional fluence coordinate is incident ions per translating-layer real atom. Section 2.5 uses 2.5 nm cells described as comparable to the halogenated-layer depth; the thesis also reports a 1.2 nm AR-XPS mixing witness and a 2--3 nm theoretical layer for its Cl/Si antecedent. The adapter uses 2.5 nm nominally and preserves 1.2--3.0 nm as a cross-chemistry sensitivity, never a depth fit. | `data/surface_interactions/guo_2009/README.md` |
| Q9 | The transferred Guo/Yin energy regression ends at 370 eV, whereas the digitized Krüger Figure-4(a) IEAD begins at 471 eV. Therefore none of its probability mass is interpolation within that regression board. | `KRUEGER-IEAD-ENERGY-SUPPORT-R1`; every nominal Guo/Krüger ion event is an energy extrapolation before the separate species and chemistry mismatches are considered. |

_Harvested 4 quoted + 4 unquoted mentions across the repo's docs._
