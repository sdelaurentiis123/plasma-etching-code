...
| Experimental validation/transfer | Raw-source provenance; preregistered calibration/held-out split; replayable extraction; measurement/digitization/numerical/parameter/model errors separated; held-out profile/AR/recipe predictions | Krüger calibration/held-out trend facts and both checksum-verified Zenodo Bosch wafer tables are ingested with evidence labels. The newly added 89-position table contributes 7,832 measurements over 88 wafers and preserves 157 original missing values separately from processed thickness. It is reactor/wafer-scale depth and uniformity evidence, not feature-profile validation. de Boer, ALE/cryo, and literature targets remain mixed-strength; no unified SiO2 held-out profile transfer result exists | **open** |
